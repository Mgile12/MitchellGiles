...
export default function SEOFAQ({ faqItems }: Props) {
  return (
    <section className="bg-navy-950 text-slate-50" aria-labelledby="seo-faq-heading">
      <AnimateOnScroll className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="mb-12">
          ...
          <h2 id="seo-faq-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-white font-serif">
