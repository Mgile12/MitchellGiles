        ...
        <div className="animate-fade-in-up animate-delay-100 space-y-8">
          ...
          <div className="rounded-xl border border-white/[0.06] bg-navy-900 p-6 sm:p-8">
            <div className="max-w-none">
              ...
              <p className="text-xl sm:text-2xl font-semibold text-white italic mb-4 pl-4 border-l-4 border-gold font-serif">
                &ldquo;This was the first year I actually felt successful.&rdquo;
              </p>
          ...
          <div className="rounded-xl border border-white/[0.06] bg-navy-900 p-6 sm:p-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-gold/10 rounded-lg p-4 border border-gold/20 hover-scale"
                >
          ...
          <div className="rounded-xl border border-white/[0.06] bg-navy-800 p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {images.map((img, i) => (
                <div
                  key={i}
                  className="rounded-lg overflow-hidden border border-white/[0.06] bg-navy-900 hover-scale"
                >
                  <img src={img.src} alt={img.alt} className="w-full h-auto object-cover" />
                </div>
              ))}
              <div className="rounded-lg overflow-hidden border border-white/[0.06] bg-navy-900 md:col-span-2 hover-scale">
                <img
          ...
          <div className="rounded-xl border border-gold/20 bg-navy-800 p-8 sm:p-12">
            ...
            <blockquote className="text-xl sm:text-2xl font-semibold text-white italic pl-6 border-l-4 border-gold font-serif">
              &ldquo;After 7 years of building, this was the first year I actually felt successful.&rdquo;
            </blockquote>
          </div>
