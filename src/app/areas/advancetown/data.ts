...
export const areaData: AreaPageData = {
  ...
  whyDifferentIntro: [
    'Search behaviour in Advancetown is different from coastal suburbs. Growth here comes from structured visibility, authority, and consistent follow-up.',
  ],
  whyDifferentPoints: [
    'Advancetown search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Advancetown search behaviour',
  ...
  landmarks: [
    { name: 'Advancetown', time: '20\u201325 minutes drive' },
    { name: 'Advancetown local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Advancetown?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Advancetown and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Advancetown businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Advancetown.',
    },
    {
      question: 'Do you offer SEO services for Advancetown?',
      answer:
        'Yes. Local SEO is essential for Advancetown businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Advancetown.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Marine Parade Southport office serving Advancetown',
    },
    {
      src: 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'Advancetown local SEO consultant Gold Coast',
    },
  ],
  internalLinks: [
