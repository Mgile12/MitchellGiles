...
export const areaData: AreaPageData = {
  ...
  heroIntro: [
    ...
    'You\u2019re not relying on walk-ins.',
  ],
  whyDifferentTitle: 'Why Gilberton Businesses Need Smarter Marketing',
  whyDifferentIntro: [
    'Gilberton businesses often service: Search behaviour overlaps heavily.',
  ],
  whyDifferentPoints: [
    'Gilberton search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Gilberton search behaviour',
  ...
  landmarks: [
    { name: 'Gilberton', time: '20\u201325 minutes drive' },
    { name: 'Gilberton local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Gilberton?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Gilberton and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Gilberton businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Gilberton.',
    },
    {
      question: 'Do you offer SEO services for Gilberton?',
      answer:
        'Yes. Local SEO is essential for Gilberton businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Gilberton.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: '\u201cLocal SEO strategy Gilberton business\u201d',
    },
  ],
  internalLinks: [
