...
export const areaData: AreaPageData = {
  ...
  heroIntro: [
    ...
    'If you run a business here, you\u2019re not relying on walk-ins.',
  ],
  whyDifferentTitle: 'Why Guanaba Businesses Need a Different Marketing Strategy',
  whyDifferentIntro: [
    'Guanaba businesses typically service: Search behaviour overlaps.',
  ],
  whyDifferentPoints: [
    'Guanaba search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Guanaba search behaviour',
  ...
  landmarks: [
    { name: 'Guanaba', time: '20\u201325 minutes drive' },
    { name: 'Guanaba local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Guanaba?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Guanaba and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Guanaba businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Guanaba.',
    },
    {
      question: 'Do you offer SEO services for Guanaba?',
      answer:
        'Yes. Local SEO is essential for Guanaba businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Guanaba.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: '\u201cLocal SEO strategy Guanaba business\u201d',
    },
  ],
  internalLinks: [
