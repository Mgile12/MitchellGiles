...
export const areaData: AreaPageData = {
  ...
  heroIntro: [
    ...
    'Broadbeach operators',
  ],
  whyDifferentTitle: 'Why Mermaid Waters Businesses Need a Strategic Marketing System',
  whyDifferentIntro: [
    'Mermaid Waters businesses often serve: Search behaviour overlaps heavily.',
  ],
  whyDifferentPoints: [
    'Mermaid Waters search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Mermaid Waters search behaviour',
  ...
  landmarks: [
    { name: 'Mermaid Waters', time: '20\u201325 minutes drive' },
    { name: 'Mermaid Waters local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Mermaid Waters?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Mermaid Waters and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Mermaid Waters businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Mermaid Waters.',
    },
    {
      question: 'Do you offer SEO services for Mermaid Waters?',
      answer:
        'Yes. Local SEO is essential for Mermaid Waters businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Mermaid Waters.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: '\u201cLocal SEO strategy Mermaid Waters business\u201d',
    },
  ],
  internalLinks: [
