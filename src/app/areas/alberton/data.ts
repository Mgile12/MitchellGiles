...
export const areaData: AreaPageData = {
  ...
  whyDifferentIntro: [
    'Search behaviour in Alberton is different from coastal suburbs. Growth here comes from structured visibility, authority, and consistent follow-up.',
  ],
  whyDifferentPoints: [
    'Alberton search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Alberton search behaviour',
  ...
  landmarks: [
    { name: 'Alberton', time: '20\u201325 minutes drive' },
    { name: 'Alberton local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Alberton?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Alberton and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Alberton businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Alberton.',
    },
    {
      question: 'Do you offer SEO services for Alberton?',
      answer:
        'Yes. Local SEO is essential for Alberton businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Alberton.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Southport office serving Alberton businesses',
    },
    {
