...
export const areaData: AreaPageData = {
  ...
  heroIntro: [
    ...
    'But while the lifestyle is calm, business competition isn\u2019t.',
  ],
  whyDifferentTitle: 'Why Neranwood Businesses Need More Than Referrals',
  whyDifferentIntro: [
    'Many Neranwood operators rely heavily on:',
  ],
  whyDifferentPoints: [
    'Neranwood search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Neranwood search behaviour',
  ...
  landmarks: [
    { name: 'Neranwood', time: '20\u201325 minutes drive' },
    { name: 'Neranwood local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Neranwood?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Neranwood and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Neranwood businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Neranwood.',
    },
    {
      question: 'Do you offer SEO services for Neranwood?',
      answer:
        'Yes. Local SEO is essential for Neranwood businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Neranwood.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Business marketing near Little Nerang Dam',
    },
    {
      src: 'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'Hinterland SEO services Gold Coast',
    },
  ],
  internalLinks: [
