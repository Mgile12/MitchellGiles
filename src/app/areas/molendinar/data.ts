...
export const areaData: AreaPageData = {
  ...
  heroIntro: [
    ...
    'Warehouses. Trade suppliers. Medical proximity. Education flow from Griffith University.',
  ],
  whyDifferentTitle: 'Why Molendinar Businesses Need Revenue Systems',
  whyDifferentIntro: [
    'Molendinar is uniquely positioned:',
  ],
  whyDifferentPoints: [
    'Molendinar search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Molendinar search behaviour',
  ...
  landmarks: [
    { name: 'Molendinar', time: '20\u201325 minutes drive' },
    { name: 'Molendinar local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Molendinar?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Molendinar and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Molendinar businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Molendinar.',
    },
    {
      question: 'Do you offer SEO services for Molendinar?',
      answer:
        'Yes. Local SEO is essential for Molendinar businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Molendinar.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Marketing services near Griffith University Gold Coast',
    },
    {
      src: 'https://images.pexels.com/photos/3182812/pexels-photo-3182812.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'Revenue systems for Molendinar businesses',
    },
  ],
  internalLinks: [
