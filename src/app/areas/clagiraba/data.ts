...
export const areaData: AreaPageData = {
  ...
  metaDescription:
    'Looking for the best Marketing Agency Gold Coast in Clagiraba? MRG Marketing builds revenue-driven marketing systems with full transparency. Call 0474 870 535 today.',
  heroH1:
  ...
  whyDifferentIntro: [
    'Search behaviour in Clagiraba is different from coastal suburbs. Growth here comes from structured visibility, authority, and consistent follow-up.',
  ],
  whyDifferentPoints: [
    'Clagiraba search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Clagiraba search behaviour',
  ...
  landmarks: [
    { name: 'Clagiraba', time: '20\u201325 minutes drive' },
    { name: 'Clagiraba local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Clagiraba?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Clagiraba and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Clagiraba businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Clagiraba.',
    },
    {
      question: 'Do you offer SEO services for Clagiraba?',
      answer:
        'Yes. Local SEO is essential for Clagiraba businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Clagiraba.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Lower Beechmont marketing strategy services',
    },
    {
