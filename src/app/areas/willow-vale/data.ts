...
export const areaData: AreaPageData = {
  ...
  whyDifferentIntro: [
    'Data-Driven Accountability Search behaviour spans multiple postcodes',
  ],
  whyDifferentPoints: [
    'Willow Vale search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Willow Vale search behaviour',
  ...
  landmarks: [
    { name: 'Willow Vale', time: '20\u201325 minutes drive' },
    { name: 'Willow Vale local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Willow Vale?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Willow Vale and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Willow Vale businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Willow Vale.',
    },
    {
      question: 'Do you offer SEO services for Willow Vale?',
      answer:
        'Yes. Local SEO is essential for Willow Vale businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Willow Vale.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Business marketing near Ruffles Road Reserve',
    },
    {
