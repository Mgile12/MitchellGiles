...
export const areaData: AreaPageData = {
  ...
  heroIntro: [
    ...
    'New estates. New families. New businesses. Constant construction.',
  ],
  whyDifferentTitle: 'Why Pimpama Businesses Need Structured Marketing',
  whyDifferentIntro: [
    'That means:',
  ],
  whyDifferentPoints: [
    'Pimpama search patterns require suburb-level targeting',
  ...
  landmarks: [
    { name: 'Pimpama', time: '20\u201325 minutes drive' },
    { name: 'Pimpama local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Pimpama?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Pimpama and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Pimpama businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Pimpama.',
    },
    {
      question: 'Do you offer SEO services for Pimpama?',
      answer:
        'Yes. Local SEO is essential for Pimpama businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Pimpama.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Business growth near Pimpama Sports Hub',
    },
    {
    ...
    },
    {
      ...
      alt: 'Local SEO services Pimpama',
    },
  ],
  internalLinks: [
