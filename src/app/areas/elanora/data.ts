...
export const areaData: AreaPageData = {
  ...
  heroIntro: [
    ...
    'You\u2019ve got school traffic near Elanora State High, weekend crowds at Palm Beach Parklands, and steady foot traffic around The Pines Shopping Centre. Businesses here rely on:',
  ],
  whyDifferentTitle: 'Why Elanora Businesses Need a Different Marketing Approach',
  whyDifferentIntro: [
    'Elanora sits between: Search behaviour overlaps.',
  ],
  whyDifferentPoints: [
    'Elanora search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Elanora search behaviour',
  ...
  landmarks: [
    { name: 'Elanora', time: '20\u201325 minutes drive' },
    { name: 'Elanora local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Elanora?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Elanora and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Elanora businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Elanora.',
    },
    {
      question: 'Do you offer SEO services for Elanora?',
      answer:
        'Yes. Local SEO is essential for Elanora businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Elanora.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: '\u201cLocal SEO strategy Elanora business\u201d',
    },
  ],
  internalLinks: [
