...
export const areaData: AreaPageData = {
  ...
  whyDifferentIntro: [
    'Search behaviour in Burleigh Waters is different from coastal suburbs. Growth here comes from structured visibility, authority, and consistent follow-up.',
  ],
  whyDifferentPoints: [
    'Burleigh Waters search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Burleigh Waters search behaviour',
  ...
  landmarks: [
    { name: 'Burleigh Waters', time: '20\u201325 minutes drive' },
    { name: 'Burleigh Waters local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Burleigh Waters?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Burleigh Waters and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Burleigh Waters businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Burleigh Waters.',
    },
    {
      question: 'Do you offer SEO services for Burleigh Waters?',
      answer:
        'Yes. Local SEO is essential for Burleigh Waters businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Burleigh Waters.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Burleigh Head National Park business marketing',
    },
    {
  ...
  internalLinks: [
    ...
    { href: '/areas/burleigh-heads', label: 'Burleigh Heads Marketing' },
