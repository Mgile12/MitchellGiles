...
export const areaData: AreaPageData = {
  ...
  metaDescription:
    'Looking for the best Marketing Agency Gold Coast in Benowa? MRG Marketing Agency Gold Coast Gold Coast builds transparent, revenue-focused systems. Call 0474 870 535.',
  heroH1:
  ...
  whyDifferentIntro: [
    'Search behaviour in Benowa is different from coastal suburbs. Growth here comes from structured visibility, authority, and consistent follow-up.',
  ],
  whyDifferentPoints: [
    'Benowa search patterns require suburb-level targeting',
  ...
  whyChooseLocalAuthority: [
    ...
    'Deep understanding of Benowa search behaviour',
  ...
  landmarks: [
    { name: 'Benowa', time: '20\u201325 minutes drive' },
    { name: 'Benowa local area', time: '20\u201325 minutes drive' },
  ...
  faqItems: [
    ...
    {
      question: 'Are you based in Benowa?',
      answer:
        'Our office is at 82 Marine Parade, Southport QLD 4215, servicing Benowa and the wider Gold Coast.',
    },
    {
    ...
    {
      question: 'Can you help with lead generation for Benowa businesses?',
      answer:
        'Lead generation systems deliver consistent, qualified enquiries through SEO, Google Ads, email marketing, and automation tailored to Benowa.',
    },
    {
      question: 'Do you offer SEO services for Benowa?',
      answer:
        'Yes. Local SEO is essential for Benowa businesses competing for suburb-level search visibility.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Book a strategy session covering your current performance, identifying gaps, and outlining a plan for predictable growth in Benowa.',
    },
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Benowa Gardens Shopping Centre local marketing expert',
    },
    {
      src: 'https://images.pexels.com/photos/3184357/pexels-photo-3184357.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'Southport office serving Benowa businesses',
    },
    {
