...
const stats = [
  { value: '40+', label: 'Clients Served', icon: Users },
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-12 lg:gap-16 items-start">
            <div className="lg:pt-4 lg:sticky lg:top-8">
              <div className="inline-flex items-center gap-2 bg-gold/10 border border-gold/20 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-xs font-semibold text-gold tracking-widest uppercase">Free Strategy Session</span>
              </div>

              <h1 className="text-3xl sm:text-4xl font-bold text-white leading-tight mb-4">
                Book Your Free<br />
                <span className="text-gold">Growth Strategy Call</span>
              </h1>

              <p className="text-slate-400 text-base leading-relaxed mb-8">
                In 30 minutes, we'll map out exactly how to grow your Gold Coast business online — with a clear, channel-specific plan you can act on immediately.
              </p>
